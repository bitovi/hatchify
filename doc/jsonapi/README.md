...
Hatchify implements [JSON:API 1.1](https://jsonapi.org/format/1.1/). While some parts of the JSON:API specs is left unspecified, this document goes over the Hatchify implementation:
