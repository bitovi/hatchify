...
describe("indexNamespace", () => {
  const LipitorUser: HatchifyModel = {
    ...
    hasMany: [{ target: "Pfizer__Todo", options: { as: "lipitorTodos" } }],
  }
  const XanaxUser: HatchifyModel = {
    ...
    hasMany: [{ target: "Pfizer__Todo", options: { as: "xanaxTodos" } }],
  }
  ...
  const Todo: HatchifyModel = {
    ...
    belongsTo: [
      { target: "Lipitor__User", options: { as: "lipitorUser" } },
      { target: "Xanax__User", options: { as: "xanaxUser" } },
    ],
  }
  ...
  describe("buildParserForModel", () => {
    it("builds a parser for a model", async () => {
      const parser = buildParserForModel(hatchedNode, "Pfizer__Todo")
