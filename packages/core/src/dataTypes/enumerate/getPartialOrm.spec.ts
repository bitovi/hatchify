...
describe("getPartialOrm", () => {
  ...
  it("handles invalid values", () => {
    expect(() =>
      getPartialOrm({} as unknown as PartialEnumProps<boolean>),
    ).toThrow(
    ...
    expect(() =>
      getPartialOrm({ values: null } as unknown as PartialEnumProps<boolean>),
    ).toThrow(
      new HatchifyInvalidSchemaError(
        "enum must be called with values as a non-empty string array",
      ),
    ...
    expect(() =>
      getPartialOrm({ values: 1 } as unknown as PartialEnumProps<boolean>),
    ).toThrow(
      new HatchifyInvalidSchemaError(
        "enum must be called with values as a non-empty string array",
      ),
    ...
    expect(() =>
      getPartialOrm({ values: "foo" } as unknown as PartialEnumProps<boolean>),
    ).toThrow(
      new HatchifyInvalidSchemaError(
        "enum must be called with values as a non-empty string array",
      ),
    ...
    expect(() =>
      getPartialOrm({ values: [] } as unknown as PartialEnumProps<boolean>),
    ).toThrow(
      new HatchifyInvalidSchemaError(
        "enum must be called with values as a non-empty string array",
      ),
