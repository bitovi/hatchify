...
router.get("/sales-people", hatchedKoa.middleware.<a href="./koa/hatchedKoa.middleware.md#allmodels">allModels</a>.<a href="./koa/hatchedKoa.middleware.md#all">all</a>);
...
await hatchedKoa.parse.SalesPerson.<a href="./koa/hatchedKoa.parse.md#destroy">destroy</a>("filter[name]=Baking")
