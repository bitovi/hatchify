...
- [`hatchedKoa`](#hatchedkoa) - An instance of `HatchifyKoa` with middleware and sequelize ORMs
  ...
  - [`hatchedKoa.parse[schemaName]`](#hatchedkoaparseschemaname) - Methods to parse a [JSON:API](../jsonapi/README.md) request and return options that can be passed to the [models](#hatchedkoaorm) to CRUD data.
