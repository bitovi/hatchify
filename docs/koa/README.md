...
router.get(  "/sales-people",     hatchedKoa.middleware.<a href="./hatchedKoa.middleware.md#hatchedkoamiddlewareallmodels">allModels</a>.<a href="./hatchedKoa.middleware.md#all">all</a>);
router.get(  "/sales-people",     hatchedKoa.middleware.SalesPerson.<a href="./hatchedKoa.middleware.md#findandcountall">findAndCountAll</a>)
router.get(  "/sales-people/:id", hatchedKoa.middleware.SalesPerson.<a href="./hatchedKoa.middleware.md#findone">findOne</a>)
...
await hatchedKoa.parse.SalesPerson.<a href="./hatchedKoa.parse.md#destroy">destroy</a>("filter[name]=Baking")
