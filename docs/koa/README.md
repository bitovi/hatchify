...
router.all(  "/sales-people",     hatchedKoa.middleware.<a href="./hatchedKoa.middleware.md#hatchedkoamiddlewareallmodels">allModels</a>.<a href="./hatchedKoa.middleware.md#all">all</a>);
